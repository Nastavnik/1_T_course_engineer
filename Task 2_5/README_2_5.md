...
# Решение
- пишим скрипты создания DDL
- заполняем тестовыми данными DML
- В таблицы mart.sql прописан скрипт создания витрины
- В docker-compose запуск процесса DDL, DML и витрины
